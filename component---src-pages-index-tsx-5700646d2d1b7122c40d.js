...
/***/ (function(module, exports, __webpack_require__) {
	...
	class WorkExp extends React.Component {
	    ...
	    render() {
	        return React.createElement("div", { className: 'workWrapper' }, React.createElement("h2", { className: 'workHeader' }, React.createElement("span", { className: 'iconAlign' }, React.createElement(fa_1.FaLaptop, null)), "  Dev Experience ", React.createElement("span", { className: 'iconAlign' }, React.createElement(fa_1.FaLaptop, null))), React.createElement("p", { className: 'workIntro' }, "I finally felt like a real programer after spending my 2+ years in Purpletalk and with multiple nightouts."), React.createElement("h3", { className: 'projTitle' }, "Mes-Icons"), React.createElement("p", { className: 'abtProj' }, "This is one of the coolest projects.It is a kind of svg icon library similar to font-awesome icons published as private npm library for our internal projects."), React.createElement("h3", { className: 'projTitle' }, "Senzit  "), React.createElement("p", { className: 'abtProj' }, "Its an cross platform app developed with Ionic 2 and Angular 2, ngrx(store).I was responsible for the complete frontend and also released multiple versions to the app store and playstore. "), React.createElement("h3", { className: 'projTitle' }, "DataTrac  "), React.createElement("p", { className: 'abtProj' }, "Its an cross platform app developed with cordova and Reactjs, Redux.We have used couple of plugins like camera, bluetooth. "));
	    }
	}
...
//# sourceMappingURL=component---src-pages-index-tsx-5700646d2d1b7122c40d.js.map